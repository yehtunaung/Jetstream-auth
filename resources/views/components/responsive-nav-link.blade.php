...
$classes = ($active ?? false)
            ? 'align-middle select-none font-sans font-bold text-center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none py-3 rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 text-black dark:text-white shadow-xl shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85]   flex items-center gap-4 px-4 capitalize '//active
